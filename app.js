...
const aboutContent =
  "This is a simple blog website built using JavaScript, HTML, CSS, Node, Express, MongoDB and Mongoose. You can find the source code in the github repo by clicking the button below.";
